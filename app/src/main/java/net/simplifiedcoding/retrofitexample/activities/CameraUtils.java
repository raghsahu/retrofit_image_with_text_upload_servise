...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaStorageDir = new File(
                ...
                SignInActivity.GALLERY_DIRECTORY_NAME);

        // Create the storage directory if it does not exist
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
//                Log.e(SignInActivity.GALLERY_DIRECTORY_NAME, "Oops! Failed create "
//                        + AddPostActivity.GALLERY_DIRECTORY_NAME+ " directory");
                return null;
            }
        }
        ...
        File mediaFile;
        if (type == SignInActivity.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + "IMG_" + timeStamp + "." + SignInActivity.IMAGE_EXTENSION);
        }  else {
            return null;
        }
